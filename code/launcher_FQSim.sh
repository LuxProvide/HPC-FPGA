#!/bin/bash -l
#SBATCH --chdir=/project/home/lxp/ekieffer/Training/epicure-hpc-fpga/code/FQSim
...
cmake -DUSER_FPGA_FLAGS="-Xsfast-compile -Xsparallel=128 -lGL -lGLU -lglut" .. && make VERBOSE=3 fpga
